        ...
        <div className="mb-4 flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-zinc-600">
              <span className="font-medium text-zinc-900 dark:text-zinc-100">{fileName}</span> is
        ...
        <div className="space-y-2">
          {canReplace && (
            <button
              ...
              onClick={onReplace}
              disabled={busy}
              className="w-full rounded-xl border border-zinc-200 bg-white px-4 py-3 text-left text-sm transition hover:border-indigo-300 hover:bg-indigo-50 disabled:opacity-60 dark:border-zinc-800 dark:bg-zinc-950 dark:hover:border-indigo-500 dark:hover:bg-indigo-950/30"
            >
              <span className="font-medium text-zinc-900 dark:text-zinc-100">Replace existing file</span>
          ...
          <button
            ...
            className="w-full rounded-xl border border-zinc-200 bg-white px-4 py-3 text-left text-sm transition hover:border-indigo-300 hover:bg-indigo-50 disabled:opacity-60 dark:border-zinc-800 dark:bg-zinc-950 dark:hover:border-indigo-500 dark:hover:bg-indigo-950/30"
          >
            <span className="font-medium text-zinc-900 dark:text-zinc-100">Keep both</span>
            <span className="mt-0.5 block text-zinc-500">
